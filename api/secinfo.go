...
func GetNamedSecurityInfo(objectName string, objectType int32, secInfo uint32, owner, group **windows.SID, dacl, sacl *windows.Handle, secDesc **SECURITY_DESCRIPTOR) error {
